...
class TripCalculator {
  ...
  static double calculateEfficiencyScore({
    ...
    if (energyConsumedKWh == 0) return 0.0;
  ...
  static double calculateAverageEfficiency(List<double> efficiencyScores) {
    if (efficiencyScores.isEmpty) return 0.0;
