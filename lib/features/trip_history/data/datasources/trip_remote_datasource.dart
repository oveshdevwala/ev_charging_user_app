  ...
  List<CompletedTripModel> _generateMockTrips() {
    ...
    final trip1 = CompletedTripModel(
      ...
      batteryTimeline: _generateBatteryTimeline(615, [
        ...
        {'distance': 300.0, 'soc': 43.0, 'charging': true},
      ]),
      chargingStops: const [
        ChargingStopModel(
          id: 'stop_1_gilroy',
          ...
          distanceFromStartKm: 123,
          distanceFromPreviousKm: 123,
          arrivalSocPercent: 55,
          departureSocPercent: 80,
          energyToChargeKwh: 18.75, // Assuming 75kWh battery
          estimatedChargeTimeMin: 20,
          estimatedCost: 6.56,
          chargerPowerKw: 150,
          network: 'Tesla',
          chargerType: ChargingStopType.tesla,
        ),
        ChargingStopModel(
          id: 'stop_2_kettleman',
          ...
          distanceFromPreviousKm: 177,
          arrivalSocPercent: 43,
          departureSocPercent: 85,
          energyToChargeKwh: 31.5, // Assuming 75kWh battery
