    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildOption(context, 1.0, 'Walking distance (1 km)'),
          _buildOption(context, 3.0, 'Short drive (3 km)'),
          _buildOption(context, 5.0, 'Nearby area (5 km)'),
          _buildOption(context, 10.0, 'Wider area (10 km)'),
          SizedBox(height: 24.h),
        ],
      ),
    );
